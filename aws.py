...
def aws_setup():
    ...
    os.system("aws ec2 run-instances --image-id ami-026669ec456129a70 --tag-specifications ResourceType=instance,Tags=[{Key=Name,Value=Tech-Trollers-Instance}] --instance-type t2.micro  --security-group-ids sg-500df37 --key-name mykey22")
